...
public class Rational implements Comparable
{
	...
	return((_numerator == newOther._numerator) && (_denominator == newOther._denominator));
	...
	if(!(other instanceof Rational)){
	    ...
	    throw new ClassCastException("the inputted parameter is NOT an instance of class Rational");
	    ...
	    Rational newOther = (Rational) other; //typecasting Object other into Rational other

	    thisNumerator = _numerator * newOther._denominator;
	    otherNumerator = _denominator *  newOther._numerator;
	...
	System.out.println("Comparing a Rational to a String, expecting a runtime error: ");
